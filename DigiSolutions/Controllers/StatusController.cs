...
namespace DigiSolutions.Controllers
{
    public class StatusController : Controller
    {
        ...
        public StatusController(DigiSolutionsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Statuses != null ? 
                          ...
                          Problem("Entity set 'DigiSolutionsContext.Statuses'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DigiSolutionsContext.Statuses'  is null.");
            }
            var status = await _context.Statuses.FindAsync(id);
            if (status != null)
            {
